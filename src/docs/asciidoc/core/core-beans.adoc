...
* Event publication
* Aa0Application-layer specific contexts such as the `WebApplicationContext`
...
=== Request, Session, Aa0Application, and WebSocket Scopes
...
and JMX support facilities. Aa0Application components can also interact with the application
...
interaction between the container and its components. Aa0Application-level beans may
