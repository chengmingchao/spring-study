...
class IntegrationTests {
  ...
  val application = Aa0Application(8181)
...
* https://github.com/spring-petclinic/spring-petclinic-kotlin[spring-petclinic-kotlin]: Kotlin version of the Spring PetClinic Sample Aa0Application
