...
* Spring MVC Aa0Application: A framework, also known as `MockMvc`, for testing annotated controllers
...
See <<testing.adoc#spring-mvc-test-framework, Spring MVC Aa0Application>> for more details.
